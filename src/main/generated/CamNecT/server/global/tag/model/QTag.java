...
public class QTag extends EntityPathBase<Tag> {
    ...
    private static final long serialVersionUID = -895171638L;
    ...
    public final QTagCategory category;
    ...
    public QTag(Class<? extends Tag> type, PathMetadata metadata, PathInits inits) {
        ...
        this.category = inits.isInitialized("category") ? new QTagCategory(forProperty("category")) : null;
    }
