...
public enum CoffeeChatErrorCode implements BaseErrorCode {
    ...
    INVALID_CHAT_CONTENT(HttpStatus.BAD_REQUEST, 48003, "메시지 내용은 비어 있을 수 없으며 16,000자를 초과할 수 없습니다."),
    ...
    INVALID_CLIENT_MESSAGE_ID(HttpStatus.BAD_REQUEST, 48006, "clientMessageId는 올바른 UUID 형식이어야 합니다."),
    ...
    IDEMPOTENCY_KEY_REUSED(HttpStatus.CONFLICT, 48903, "동일한 clientMessageId를 다른 메시지에 재사용할 수 없습니다.");
